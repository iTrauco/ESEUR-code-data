...
#bonnie 4 SeqBlockOut 5 SeqBlockIn 6 RandomRead 8 avil 9 run 10 HOUR 11 day 12 ear 13 consq Hour 
reset
set terminal  postscript enhanced color
set output "BonnieSeqOutSmall.ps"
set key box 
set key  above
set yrange[1:]
set ylabel "Sequential Write Disk Performance [KB/s]"
...
va34 = 816
va35 = 840
plot "bonnieSmallUS.csv" using  12:5	title "US location" , "bonnieSmallEU.csv" using  12:5	title "EU location",\
