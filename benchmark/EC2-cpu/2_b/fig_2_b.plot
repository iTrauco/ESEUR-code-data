#unbench: 3weekday 4 CPU (MEM) 5 avail zone 6 run 7 hour 8n day 9 year 10 cont hour 
#set datafile missing 0
reset
set terminal  postscript enhanced color
set output "CPULarge.ps"
set key box 
set key  above
set yrange[1:]
...
va34 = 816
va35 = 840
plot "cpuLargeUS.csv" using  10:4 title "US location", "cpuLargeEU.csv" using  10:4 title "EU location",\
