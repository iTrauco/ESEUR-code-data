...
set output "BonnieSeqOutLarge.ps"
set key box 
set key  above
set yrange[1:]
set ylabel "Sequential Read Disk Performance [KB/s]"
...
va34 = 816
va35 = 840
plot "bonnieLargeUS.csv" using  12:5	title "US location" , "bonnieLargeEU.csv" using  12:5	title "EU location",\
