...
set output "BonnieRandomReadLarge.ps"
set key box 
set key  above
set yrange[1:]
set ylabel "Random Read Disk Performance [KB/s]"
...
va34 = 816
va35 = 840
plot "bonnieLargeUS.csv" using  12:6 title "US location", "bonnieLargeEU.csv" using  12:6 title "EU location",\
