#unbench MEM: 3weekday 4 CPU (MEM) 5 avail zone 6 run 7 hour 8n day 9 year 10 cont hour 
...
set output "MEMLarge.ps"
set key box 
set key  above
set yrange[1:]
set ylabel "Memory Performance [Ubench score]"
set xlabel "Measurements per Hour"

set xtics ("Week 52" 168, "Week 53" 336, "Week 1" 504, "Week 2" 672, "Week 3" 840)
set parametric
set trange [1:350000]
plot "memLargeUS.csv" using  10:4 title "US location", "memLargeEU.csv" using  10:4 title "EU location",\
